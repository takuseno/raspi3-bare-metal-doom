...
static default_t	doom_defaults_list[] =
{
    ...
    CONFIG_VARIABLE_INT(joystick_physical_button),
    CONFIG_VARIABLE_INT(snd_maxslicetime_ms),
    CONFIG_VARIABLE_INT(snd_musiccmd),
    ...
    CONFIG_VARIABLE_INT(key_pause),
    CONFIG_VARIABLE_INT(key_message_refresh),
    CONFIG_VARIABLE_INT(key_weapon1),
    CONFIG_VARIABLE_INT(key_weapon2),
    CONFIG_VARIABLE_INT(key_weapon3),
    CONFIG_VARIABLE_INT(key_weapon4),
    CONFIG_VARIABLE_INT(key_weapon5),
    CONFIG_VARIABLE_INT(key_weapon6),
    CONFIG_VARIABLE_INT(key_weapon7),
    CONFIG_VARIABLE_INT(key_weapon8),
    CONFIG_VARIABLE_INT(key_prevweapon),
    CONFIG_VARIABLE_INT(key_nextweapon),
    ...
    CONFIG_VARIABLE_INT(key_map_north),
    CONFIG_VARIABLE_INT(key_map_south),
    CONFIG_VARIABLE_INT(key_map_east),
    CONFIG_VARIABLE_INT(key_map_west),
    CONFIG_VARIABLE_INT(key_map_zoomin),
    CONFIG_VARIABLE_INT(key_map_zoomout),
    CONFIG_VARIABLE_INT(key_map_toggle),
    CONFIG_VARIABLE_INT(key_map_maxzoom),
    CONFIG_VARIABLE_INT(key_map_follow),
    CONFIG_VARIABLE_INT(key_map_grid),
    CONFIG_VARIABLE_INT(key_map_mark),
    CONFIG_VARIABLE_INT(key_map_clearmark),
    CONFIG_VARIABLE_INT(key_menu_activate),
    CONFIG_VARIABLE_INT(key_menu_up),
    CONFIG_VARIABLE_INT(key_menu_down),
    CONFIG_VARIABLE_INT(key_menu_left),
    CONFIG_VARIABLE_INT(key_menu_right),
    CONFIG_VARIABLE_INT(key_menu_back),
    CONFIG_VARIABLE_INT(key_menu_forward),
    CONFIG_VARIABLE_INT(key_menu_confirm),
    CONFIG_VARIABLE_INT(key_menu_abort),
    CONFIG_VARIABLE_INT(key_menu_help),
    CONFIG_VARIABLE_INT(key_menu_save),
    CONFIG_VARIABLE_INT(key_menu_load),
    CONFIG_VARIABLE_INT(key_menu_volume),
    CONFIG_VARIABLE_INT(key_menu_detail),
    CONFIG_VARIABLE_INT(key_menu_qsave),
    CONFIG_VARIABLE_INT(key_menu_endgame),
    CONFIG_VARIABLE_INT(key_menu_messages),
    CONFIG_VARIABLE_INT(key_menu_qload),
    CONFIG_VARIABLE_INT(key_menu_quit),
    CONFIG_VARIABLE_INT(key_menu_gamma),
    CONFIG_VARIABLE_INT(key_menu_incscreen),
    CONFIG_VARIABLE_INT(key_menu_decscreen),
    CONFIG_VARIABLE_INT(key_menu_screenshot),
    CONFIG_VARIABLE_INT(key_demo_quit),
    CONFIG_VARIABLE_INT(key_spy),
